...
SECRET_KEY = 'django-insecure-6eff-+c=_f0+0thl)v=_eoji2koj8di2!te8%&y51_702!r(ea'
...
#Отвечает за отоброжение DRF в браузере
#НАСТРОЙКИ DRF для отображения
# IsAuthenticated означает что доступ дан авторизованным пользователям